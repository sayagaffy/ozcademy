...
export function RegisterForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Optional: you could pass state here to show a success message on the login page
            navigate('/login', { state: { message: 'Registrasi berhasil. Silakan log in.' } });
        } catch (err: any) {
            setError(err.message || 'Gagal meregistrasi akun.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="w-full">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <Button type="submit" className="w-full rounded-xl mt-4" size="lg" disabled={isLoading}>
